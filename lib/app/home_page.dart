            ...
            children: [
              Consumer(
                builder: (context, ref, _) {
                  ...
                  return Text(switch (availability) {
                    AsyncData(:final value) => switch (value) {
                      ...
                      Err(:final failure) =>
                        'Health Connect: error (${failure.message})',
                    },
                    AsyncError() =>
                      'Health Connect: error checking availability',
                      ...
                      Consumer(
                        builder: (context, ref, _) {
                          final permission = ref.watch(
                            healthPermissionControllerProvider,
                          );
                                ...
                                AsyncData(:final value) => switch (value) {
                                  Ok(:final value) =>
                                    value
                                        ...
                                        : 'Permission: denied',
                                  Err(:final failure) =>
                                    'Permission: error (${failure.message})',
                                },
              ...
              Consumer(
                builder: (context, ref, _) {
                  ...
                  if (playerState == null) {
                    return const Text('Player: loading...');
                  }
                  return Column(
                    children: [
                      Text(
                      ...
                      Text(
                        'Energy: ${playerState.energy}   Gold: ${playerState.gold}',
                      ),
                      ElevatedButton(
                        onPressed: () async {
